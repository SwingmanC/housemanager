...
import com.example.demo.entity.AddressInfoExample.Criteria;
import com.example.demo.entity.AddressInfoExample.Criterion;
...
public class AddressInfoSqlProvider {
    ...
    public String countByExample(AddressInfoExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("address_info");
