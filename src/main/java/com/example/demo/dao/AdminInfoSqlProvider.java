...
import com.example.demo.entity.AdminInfoExample.Criteria;
import com.example.demo.entity.AdminInfoExample.Criterion;
...
public class AdminInfoSqlProvider {
    ...
    public String countByExample(AdminInfoExample example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("admin_info");
